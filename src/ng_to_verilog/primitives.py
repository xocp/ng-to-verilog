					...
					for connection in component["connections"]:
						if connection[connectionKey]["nodeId"] == nodeId:
							...
							if newConnectorId >= 0:
								...
								raise Exception(f"You have selected a word_size of {word_size}, but component {component['componentName']} ({component['name']}) has a reference to a {nodeType} that accesses bits outside of the word boundary (i.e. bit {ngv.DEFAULT_WORD_SIZE - connectorId - 1})")
